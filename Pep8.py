...
Algumas informações da Pep8, alguns casos:

[1] - Utilize Camel Case para nomes de classes;(CalculadoraCientifica...)
class Calculadora:
    pass
...
[3] - Utilize 4 espaços para identação!(NÃO use tab-> recomendado 4 espaços)
...
[6] - Espaços em ecpressões e instruções
